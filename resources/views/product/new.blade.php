                ...
                <div class="">
                    <form method="POST" action="{{ route('store.product.create') }}">
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <input id="price" type="number" class=" @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" autofocus placeholder=0 min=0>
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <input id="sellby" type="date" class=" @error('sellby') is-invalid @enderror" name="sellby" value="{{ old('sellby') }}" autofocus>
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <input id="store_id" type="text" class=" @error('store_id') is-invalid @enderror" name="store_id" value="{{ old('store_id') }}" autofocus>
