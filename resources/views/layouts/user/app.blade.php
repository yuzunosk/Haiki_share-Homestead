...
<body class="l_site__area">
    <div class="l-site__warapper">
        ...
        <nav class="l-header">
                <a class="l-header__left u_site--title u_site--title--bold u_display--center" href="{{ url('/user/home') }}">
                    ...
                    <!-- ログインしてなければ表示 -->
                     ...
                     <div class="display-sm">
                         <div class="l-header__right">
                             <i id="js-click-popup" class="fas fa-bars fa-5x l-header__right__4 u_display--center"></i>
                         </div>
                     </div>
                     @endunless
                     {{-- ログインしていれば表示 --}}
