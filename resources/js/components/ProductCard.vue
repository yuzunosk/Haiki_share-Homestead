<template>
    <div>
        <div
            class="l_product__card__container mb-100 mr-100"
            @click="clickScreenTransition"
        >
            <p
                v-if="!isEdit"
                class="l_product__card__label u_size__icon--label"
            >
                SOLD
            </p>
            <img
                class="l_product--pic u_img__fit--cover100"
                :src="picData"
                alt="商品画像"
            />
            <div class="c_product__card__container">
                <p
                    class="c_product__card--name u_display--Jstart u_font__default"
                >
                    {{ p_data.name }}
                </p>
                <p
                ...
                <div class="c_product__card--unit">
                    ...
                    <a
                        :href="info_link"
                        class="c_product__card--unit--iconB u_size__icon--card"
                    >
